...
const file_pubsub_proto_rawDesc = "" +
	"\n" +
	"\fpubsub.proto\x12\rproto.package\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\x06PubSub\x12D\n" +
	"\tSubscribe\x12\x1f.proto.package.SubscribeRequest\x1a\x14.proto.package.Event0\x01\x12@\n" +
	"\aPublish\x12\x1d.proto.package.PublishRequest\x1a\x16.google.protobuf.EmptyB\x0fZ\rproto.packageb\x06proto3"
...
var file_pubsub_proto_goTypes = []any{
	(*SubscribeRequest)(nil), // 0: proto.package.SubscribeRequest
	(*PublishRequest)(nil),   // 1: proto.package.PublishRequest
	(*Event)(nil),            // 2: proto.package.Event
	(*emptypb.Empty)(nil),    // 3: google.protobuf.Empty
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: proto.package.PubSub.Subscribe:input_type -> proto.package.SubscribeRequest
	1, // 1: proto.package.PubSub.Publish:input_type -> proto.package.PublishRequest
	2, // 2: proto.package.PubSub.Subscribe:output_type -> proto.package.Event
	3, // 3: proto.package.PubSub.Publish:output_type -> google.protobuf.Empty
