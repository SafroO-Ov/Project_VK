...
const (
	PubSub_Subscribe_FullMethodName = "/proto.package.PubSub/Subscribe"
	PubSub_Publish_FullMethodName   = "/proto.package.PubSub/Publish"
)
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.package.PubSub",
